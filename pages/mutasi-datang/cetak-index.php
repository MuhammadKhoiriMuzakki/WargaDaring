...
// ambil dari database
//$query = "SELECT *, TIMESTAMPDIFF(YEAR, `tanggal_lahir_warga`, CURDATE()) AS usia_mutasi FROM warga JOIN mutasi_masuk ON warga.nik_warga= mutasi_masuk.id_warga";
...
foreach ($data_mutasi as $mutasi) {
    ...
    $pdf->cell(23, 7, strtoupper($mutasi['id_warga']), 1, 0, 'C');
